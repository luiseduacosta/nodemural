...
$(document).ready(async function () {
    ...
    try {
        ...
        document.getElementById('cress').value = professor.cress || '';
        document.getElementById('regiao').value = professor.regiao || '';
        ...
        document.getElementById('curriculolattes').value = professor.curriculolattes || '';
