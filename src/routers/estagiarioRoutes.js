...
router.get('/:id/atividades', verifyToken, checkRole(['admin', 'aluno', 'docente', 'supervisor']), estagiarioController.getAtividadesByEstagiarioId);
router.get('/:id', verifyToken, checkRole(['admin', 'aluno', 'docente', 'supervisor']), estagiarioController.getEstagiarioById);
