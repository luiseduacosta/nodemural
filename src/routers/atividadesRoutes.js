...
import { verifyToken, checkRole, checkOwnership, checkAtividadeOwnership } from '../middleware/auth.js';
...
router.put('/:id', verifyToken, checkRole(['admin', 'aluno']), checkAtividadeOwnership, atividadesController.updateAtividade);
router.delete('/:id', verifyToken, checkRole(['admin', 'aluno']), checkAtividadeOwnership, atividadesController.deleteAtividade);
